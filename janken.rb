...
class Player
  ...
  class Janken
    def pon(player_hand, enemy_hand)
      ...
      if # Si la valeur de retour de la classe Player (player_hand) et la valeur de retour de la classe Enemy (enemy_hand) sont les mêmes...
        # "Aiko" est produit.
        puts "あいこ"
      ...
      elsif # Si les combinaisons suivantes sont trouvées.
